                            ...
                            <div class="col-md-12 pt-5">
                                <div class="large-12">
                                    ...
                                    <div class="toggleview">
                                        ...
                                        <div class="large-12 forum-topic" v-for="(value, index) in discussionsWithType" style="background: #fff">
                                            <div class="large-1 column lpad">
...
<script>
    ...
    export default {
        ...
        mounted (){
            this.getdiscussionWithType(this.pagination.current_page);
        ...
        methods:{
            getdiscussionWithType (page) {
                this.axios.get('/api/discussionwithtype/' + this.discussiontype_id + '/paginate?page='+page)
                    .then((response) => {
                        this.nameType = response.data.data[0].name_discussion_type
                        this.discussionsWithType = response.data.data
