	...
	export default {
		data() {
			return {
				...
				complete: false,
				keyword: this.$route.params.tukhoa,
			}
		},
		created(){
...
/*    a:hover,
    ...
    */
	...
	/*.search-result .img-thumbnail { border-radius: 0 !important; }*/
	.search-result:first-child { margin-top: 0 !important; }
	.search-result { margin-top: 20px; }
	.search-result .col-md-2 { border-right: 1px dotted #ccc; min-height: 140px; padding-left: 1em;}
