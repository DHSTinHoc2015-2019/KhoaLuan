<template>
	<div>
    	<app-user-library-document-create-breadcrumb-component></app-user-library-document-create-breadcrumb-component>
			...
			<div class="row mb-5">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">                      
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                        	<form v-on:submit.prevent="updateLibraryDocument">
                            <div class="row">
								<div class="col-md-6">
...
<script>
	import UserLibraryDocumentCreateBreadcrumbComponent from './UserLibraryDocumentCreateBreadcrumbComponent.vue';

	export default {
		components: {
            appUserLibraryDocumentCreateBreadcrumbComponent: UserLibraryDocumentCreateBreadcrumbComponent,
        },
		data(){
			return {
				library_document: {},
