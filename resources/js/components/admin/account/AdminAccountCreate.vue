				...
				<div class="row mb-5">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">                      
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                            	<form v-on:submit.prevent="createAccount" enctype="multipart/form-data">
                                <div class="row">
                                	<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="password" class="form-control" aria-describedby="" placeholder="Nhập mật khẩu" required="" v-model="users.password">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="date" class="form-control" aria-describedby="" placeholder="Nhập ngày sinh" required="" v-model="users.birthday">
										</div>
									</div>
	...
	export default {
		...
		methods: {
			...
			createAccount(){
                ...
                formData.append('birthday', this.convertDate(this.users.birthday));
