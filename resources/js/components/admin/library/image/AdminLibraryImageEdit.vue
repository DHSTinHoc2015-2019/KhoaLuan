				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">                      
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3><i class="fa fa-plus"></i> Chỉnh sửa hình ảnh</h3>
                        </div>
                            
                        <div class="card-body">
                        	<form v-on:submit.prevent="editLibraryImage">
                            <div class="row">
								<div class="col-md-6">
							 	...
							 	<div class="col-md-6">
        							...
        							<div class="form-group">
        								...
        								<div id="imagePreview">
        									<img :src="'/images/library/images/' + library_image.file_name" style="display: block; margin-left: auto; margin-right: auto; max-width: 350px" />
        								</div>    
        							</div>
      							</div>
								<!-- Lưu -->
...
<script>
    ...
    //             for (let [key, value] of formData.entries()) {
				...
				axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('tpack.jwt')
				let uri = `/api/libraryimage/edit/` + this.$route.params.id;
