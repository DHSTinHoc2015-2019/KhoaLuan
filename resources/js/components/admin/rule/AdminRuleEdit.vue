				...
				<div class="row mb-5">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">                      
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                            	<form v-on:submit.prevent="editRule" enctype="multipart/form-data">
                                <div class="row">
                                	<div class="col-md-12">
...
<script>
	export default {
		...
		created(){
			...
			this.axios.get(`/api/rules/show/${this.$route.params.id}`).then((response) =>{
		...
		methods: {
			editRule(){
				...
				axios.defaults.headers.common['Content-Type'] = 'application/json'
				axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('tpack.jwt')
				let uri = '/api/rules/update/' + this.$route.params.id;
